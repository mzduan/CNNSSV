...
if __name__ == '__main__':
    ...
    # for t in range(20, 21, 1):
        tumor_vcf=open('/Users/duan/Desktop/getBreakpoint/results/random/chr'+str(t)+'/cutesv_tumor_chr'+str(t)+'_0.2.vcf','r')
        normal_vcf = open('/Users/duan/Desktop/getBreakpoint/results/random/chr'+str(t)+'/cutesv_normal_chr'+str(t)+'.vcf', 'r')

        somatic_vcf = open('/Users/duan/Desktop/getBreakpoint/results/random/chr'+str(t)+'/cutesv_somatic_chr'+str(t)+'_0.2.vcf', 'w')
